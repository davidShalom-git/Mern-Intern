...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center mt-22 mb-28 mx-auto bg-black md:w-[50%] w-[95%] rounded-3xl ">
        <h1 className="text-white text-7xl font-semibold md:mt-28 mt-28">FavBlogs....</h1>
        <p className='mt-5 text-white mb-20'>Write Your Favorite Memories....</p>
      </div>
...
<p className="text-center mb-10 bg-black text-white rounded-full text-base md:text-xl w-[90%] md:w-[30%] mx-auto px-6 py-4 md:px-10 md:py-10">
  ...
  <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
    ...
    <div className="relative group focus-within:ring-2 focus-within:ring-black w-[200px] h-[200px] md:w-[350px] md:h-[350px] rounded-full overflow-hidden cursor-pointer">
      ...
      <div className="flex flex-col justify-center md:flex-row gap-10 shadow shadow-black mb-20 w-[90%] md:w-[70%] p-6 md:p-10 mx-auto">
...
<div className="flex flex-col md:flex-row items-center justify-center gap-10 md:gap-28 px-4">
  {/* Upload */}
  <div className="shadow shadow-black p-6 md:p-10 mb-10 w-full max-w-[300px]">
    <img
      src={upload}
      alt="Upload visual"
