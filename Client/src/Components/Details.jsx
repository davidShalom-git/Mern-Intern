                                    ...
                                    {paragraphs.length > 0 ? (
                                        paragraphs.map((paragraph, index) => (
                                            <div 
                                                ...
                                                className="group"
                                            >
                                                <p className="text-gray-200 leading-relaxed text-lg font-light tracking-wide first-letter:text-3xl first-letter:font-semibold first-letter:text-purple-300 first-letter:mr-1 first-letter:float-left first-letter:leading-[0.8] hover:text-white transition-colors duration-300">
                                                    {paragraph.trim()}
                                                </p>
                                                {index < paragraphs.length - 1 && (
                                                    <div className="mt-8 flex justify-center">
                                                        <div className="flex items-center gap-2">
                                                            <div className="w-8 h-px bg-gradient-to-r from-transparent via-purple-400/50 to-purple-400/50"></div>
                                                            <div className="w-2 h-2 bg-purple-400/50 rounded-full"></div>
                                                            <div className="w-8 h-px bg-gradient-to-r from-purple-400/50 to-transparent"></div>
                                                        </div>
                                                    </div>
                                                )}
                                            </div>
